...
import { WindowDimsContext, useFilms } from '@contexts';
...
const Hero: React.FC<Hero> = ({ handleSetModal, minutesToHours }) => {
    ...
    >
      ...
      <div className="film-details">
        ...
        {heroFilm.overview && (
          ...
          >
            {heroFilm.overview && limitedText(heroFilm.overview, 'description')}
          </motion.p>
        )}
